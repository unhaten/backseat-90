	...
	return (
		<>
			<div className='flex items-center gap-4 mb-4'>
				...
				<div className='w-full'>
					<div className='flex justify-between items-center gap-2'>
						...
						>
							<Heart
								className={`fill-primary dark:stroke-black`}
							/>
						</Button>
					</div>
					<div className='mt-2'>
			...
			<div className='grid grid-cols-3'>
				<Skeleton className='skeleton-button justify-self-start' />
				<Skeleton className='skeleton-button justify-self-center' />
				<Skeleton className='skeleton-button justify-self-end' />
			</div>
		</>
	)
}
